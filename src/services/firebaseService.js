...
class FirebaseService {
  ...
  addColor = (id, color) => new Promise((resolve, reject) => {
    this.database
  ...
  removeColor = key => new Promise((resolve, reject) => {
    this.database
  ...
  addChannel = channel => new Promise((resolve, reject) => {
    this.database
      ...
      .catch(error => reject({message: "Kanal kunne ikke lagres i databasen", error}));
  });

  removeChannel = key => new Promise((resolve, reject) => {
    this.database
      .ref(`channels/${key}`)
      .remove()
      .then(data => resolve(data))
