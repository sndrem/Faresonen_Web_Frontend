export default {
  doubleScorers: [
    ...
    },
    {
      ...
      text:
        "Sánchez treffer tverrliggeren, men Lukaku setter returen! Chileneren drar til med høyreslegga fra 15 meter. Skuddet blokkeres, og det tar en halv evighet før ballen seiler ned på tverrliggeren. Returen havner i føttene på Lukaku. Belgieren bruker tid, men til slutt klarer han å lure ballen forbi et hav av Crystal Palace-spillere og i nettmaskene!",
      text2:
        "Baklengsmål Crystal Palace Hennessey\r\nScoring Man. United Etablert angrep Direkte i mål\r\nScoring2",
      videoDistributed: "1",
      videoMobilProfileId: "2",
    },
    {
      ...
      text:
        "For en hinsides scoring! Matic avgjør kampen med en suser av de sjeldne fra distanse! Manchester United opprettholder trykket inne på vertenes halvdel. Pogba fyrer fra 18 meter, men skuddet blokkeres. Nedfallsfrukten havner i beina på Matic, og serberen dunker til med venstreslegga på halvspretten fra 25 meter. Midtbanespilleren får et eventyrlig treff, og det utsøkte skuddet fyker i nettet. Eventyrlig scoring!",
      text2:
        "Baklengsmål Crystal Palace Hennessey\r\nScoring Man. United Etablert angrep Direkte i mål\r\nScoring4",
      videoDistributed: "1",
      videoMobilProfileId: "2",
  ...
  matchEvents: [
    ...
    },
    {
      ...
      text:
        "Hvilken debut for belgieren! Mkhitaryan svinger frisparket inn i feltet, hvor Lukaku river seg løs fra markeringen. Han er så voldsomt sterk i de duellene, og da kan han bare forlenge ballen i lengste hjørne. Hvilken herlig introduksjon på sin nye hjemmebane!",
      videoDistributed: "1",
      videoMobilProfileId: "2",
    },
    {
    ...
    },
    {
      ...
      text:
        "Nedsablingen er komplett, West Ham får juling her! Vertene broderer seg herlig igjennom gjestenes forsvar på ett touch, og igjen er det Mkhitaryan som er nest sist på ballen. Førstetouchen til Martial sitter, og da banker han ballen inn bak Joe Hart. Imponerende det Manchester United driver med her!",
      text2:
        "Baklengsmål West Ham Hart\r\nScoring Man. United Etablert angrep Direkte i mål\r\nScoring2",
      videoDistributed: "1",
      videoMobilProfileId: "2",
    ...
    },
    {
      ...
      text:
        "Har du sett, her renner det inn! En perfekt kamp for Manchester United krones av en herlig scoring fra franskmannen, som kombinerer med sin landsmann Martial. Avslutningen fra 20 meter er det nok fart i, og da må Joe Hart plukke sin fjerde ball ut av nettet i debuten.",
      text2:
